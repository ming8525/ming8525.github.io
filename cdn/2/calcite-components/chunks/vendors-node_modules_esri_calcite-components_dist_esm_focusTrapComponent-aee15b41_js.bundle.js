"use strict";
(self["webpackChunkexb_client"] = self["webpackChunkexb_client"] || []).push([["vendors-node_modules_esri_calcite-components_dist_esm_focusTrapComponent-aee15b41_js"],{

/***/ "./node_modules/@esri/calcite-components/dist/esm/focusTrapComponent-aee15b41.js":
/*!***************************************************************************************!*\
  !*** ./node_modules/@esri/calcite-components/dist/esm/focusTrapComponent-aee15b41.js ***!
  \***************************************************************************************/
...
var createFocusTrap = function createFocusTrap(elements, userOptions) {
  ...
  var getInitialFocusNode = function getInitialFocusNode() {
    ...
    if (node === undefined || !(0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.r)(node, config.tabbableOptions)) {
  ...
  var updateTabbableNodes = function updateTabbableNodes() {
    state.containerGroups = state.containers.map(function (container) {
      var tabbableNodes = (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.m)(container, config.tabbableOptions);

      // NOTE: if we have tabbable nodes, we must have focusable nodes; focusable nodes
      //  are a superset of tabbable nodes since nodes with negative `tabindex` attributes
      //  are focusable but not tabbable
      var focusableNodes = (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.n)(container, config.tabbableOptions);
      var firstTabbableNode = tabbableNodes.length > 0 ? tabbableNodes[0] : undefined;
      var lastTabbableNode = tabbableNodes.length > 0 ? tabbableNodes[tabbableNodes.length - 1] : undefined;
      var firstDomTabbableNode = focusableNodes.find(function (node) {
        return (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.o)(node);
      });
      var lastDomTabbableNode = focusableNodes.slice().reverse().find(function (node) {
        return (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.o)(node);
      });
      var posTabIndexesFound = !!tabbableNodes.find(function (node) {
        return (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.p)(node) > 0;
      });
      return {
        container: container,
          ...
          if (nodeIdx < 0) {
            ...
            if (forward) {
              return focusableNodes.slice(focusableNodes.indexOf(node) + 1).find(function (el) {
                return (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.o)(el);
              });
            }
  ...
  var findNextNavNode = function findNextNavNode(_ref2) {
    ...
    if (state.tabbableGroups.length > 0) {
      ...
      if (containerIndex < 0) {
        ...
        if (startOfGroupIndex < 0 && (containerGroup.container === target || (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.r)(target, config.tabbableOptions) && !(0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.o)(target, config.tabbableOptions) && !containerGroup.nextTabbableNode(target, false))) {
        ...
        if (startOfGroupIndex >= 0) {
          ...
          destinationNode = (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.p)(target) >= 0 ? destinationGroup.lastTabbableNode : destinationGroup.lastDomTabbableNode;
        ...
        if (lastOfGroupIndex < 0 && (containerGroup.container === target || (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.r)(target, config.tabbableOptions) && !(0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.o)(target, config.tabbableOptions) && !containerGroup.nextTabbableNode(target))) {
        ...
        if (lastOfGroupIndex >= 0) {
          ...
          destinationNode = (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.p)(target) >= 0 ? _destinationGroup.firstTabbableNode : _destinationGroup.firstDomTabbableNode;
        } else if (!isTabEvent(event)) {
          // user must have customized the nav keys so we have to move focus manually _within_
          //  the active group: do this based on the order determined by tabbable()
  ...
  var checkFocusIn = function checkFocusIn(event) {
    ...
    if (targetContained || target instanceof Document) {
      ...
      if (state.mostRecentlyFocusedNode) {
        if ((0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.p)(state.mostRecentlyFocusedNode) > 0) {
          ...
          if (!state.containerGroups.some(function (g) {
            return g.tabbableNodes.some(function (n) {
              return (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.p)(n) > 0;
            });
          })) {
...
function connectFocusTrap(component, options) {
  ...
  const focusTrapOptions = {
    ...
    setReturnFocus: (el) => {
      (0,_dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.d)(el);
      return false;
    },
    ...options?.focusTrapOptions,
    // the following options are not overridable
    document: el.ownerDocument,
    tabbableOptions: _dom_ed00a585_js__WEBPACK_IMPORTED_MODULE_0__.u,

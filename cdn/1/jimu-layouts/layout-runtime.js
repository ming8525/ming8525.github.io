...
`;function Vo(e){const{layoutId:t,layoutItemId:n,controllerId:i,minimized:a,onClose:r,onToggle:l}=e,[s,u]=o.React.useState(!1),d=o.React.useRef(),c=o.ReactRedux.useSelector((e=>e.appConfig.layouts[t].content[n].widgetId)),p=o.ReactRedux.useSelector((e=>{var t;const n=null===(t=e.widgetsRuntimeInfo)||void 0===t?void 0:t[c];return(null==n?void 0:n.state)===o.WidgetState.Opened})),g=o.ReactRedux.useSelector((e=>{const t=e.appConfig.widgets[c];return null==t?void 0:t.label}),o.ReactRedux.shallowEqual),v=o.ReactRedux.useSelector((e=>{var t;const o=e.widgetsRuntimeInfo[c];return null!==(t=null==o?void 0:o.isClassLoaded)&&void 0!==t&&t})),h=o.ReactRedux.useSelector((e=>e.appConfig.controllerPanels[i].effect)),f=o.React.useMemo((()=>{var e,t;return(null==h?void 0:h.type)&&h.type!==o.AnimationType.None?(0,o.getAnimationEffect)(h.type,{configType:null===(e=h.option)||void 0===e?void 0:e.configType,direction:null===(t=h.option)||void 0===t?void 0:t.direction}):null}),[h]),[m,I]=Wo((()=>o.DEFAULT_ANIMATION_PROPS),[f]),x=o.React.useCallback((e=>{r(e,c);const t=document.querySelector(`.widget-controller .avatar-card[data-widgetid='${c}']`).querySelector("button");null==t||t.focus()}),[c,r]);let w;return(0,y.useTrapFocusLoop)(d,!0,!0,!1,s&&p),o.React.useEffect((()=>{p&&!s&&(u(!0),o.WidgetManager.getInstance().loadWidgetClass(c).catch((e=>{console.log(e)})))}),[p,c,s]),o.React.useEffect((()=>{p&&null!=f&&I.start(Object.assign(Object.assign({},f.animateProps()),{onRest:()=>{o.lodash.defer((()=>{d.current.style.clipPath=null}))}}))}),[I,p,f]),s&&v&&(w=o.WidgetManager.getInstance().getWidgetClass(c)),(0,o.jsx)(Ho.div,{className:(0,o.classNames)("controller-panel flex-column w-100 h-100",{"d-none":!s||!p}),css:Do,ref:d,style:null!=f?m:null},(0,o.jsx)("div",{className:"panel-header d-flex align-items-center flex-shrink-0 px-4"},(0,o.jsx)("div",{className:"label d-flex align-items-center h-100"},(0,o.jsx)("div",{className:"text-truncate"},g)),(0,o.jsx)("div",{className:"actions ml-auto d-flex align-items-center"},(0,o.jsx)(y.Button,{className:"p-0",icon:!0,type:"tertiary",size:"sm",onClick:l},(0,o.jsx)(Fo,{css:o.css`
              transform: rotate(${a?180:0}deg);
              transition: transform 0.3s ease-in-out;
            `})),(0,o.jsx)(y.Button,{className:"p-0 ml-2",icon:!0,type:"tertiary",size:"sm",onClick:x},(0,o.jsx)(Ut,null)))),(0,o.jsx)("div",{className:"panel-content d-flex flex-grow-1"},!v&&(0,o.jsx)(y.Loading,{type:y.LoadingType.Donut}),w&&(0,o.jsx)("div",{className:"w-100 h-100 widget-content p-1"},(0,o.jsx)(o.ErrorBoundary,null,(0,o.jsx)(w,{widgetId:c,layoutId:t,layoutItemId:n})))))}function Go(e){const{controllerId:t}=e,[n,i]=o.React.useState(!1),a=o.ReactRedux.useSelector((e=>{const o=e.appConfig.widgets[t],n=o.manifest.layouts[0].name,i=o.layouts[n];return i[e.browserSizeMode]||i[e.appConfig.mainSizeMode]})),r=o.ReactRedux.useSelector((e=>{var t;const o=e.appConfig.layouts[a],n=Object.keys(null!==(t=o.content)&&void 0!==t?t:{}).filter((e=>{const t=o.content[e];return null!=(null==t?void 0:t.widgetId)&&!t.isPending}));return n.sort(),n.join(",")})),l=o.ReactRedux.useSelector((e=>{var t,n;const i=Object.keys(null!==(t=e.widgetsRuntimeInfo)&&void 0!==t?t:{}).filter((t=>e.widgetsRuntimeInfo[t].state===o.WidgetState.Opened)),r=e.appConfig.layouts[a];return Object.keys(null!==(n=r.content)&&void 0!==n?n:{}).some((e=>{const t=r.content[e];return null!=(null==t?void 0:t.widgetId)&&!t.isPending&&i.includes(t.widgetId)}))})),s=o.React.useMemo((()=>r.split(",").filter((e=>""!==e))),[r]),u=o.ReactRedux.useSelector((e=>e.appConfig.controllerPanels[t])),d=o.React.useCallback(((e,t)=>{e.stopPropagation(),(0,o.getAppStore)().dispatch(o.appActions.closeWidget(t))}),[]),c=o.React.useCallback((()=>{i(!n)}),[n]),p=o.React.useMemo((()=>o.css`
